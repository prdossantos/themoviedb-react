...
interface AlertProps {
  ...
  details?: string; // Nova propriedade para detalhes em markdown
}

const Alert: React.FC<AlertProps> = ({ message, type = 'info', details }) => {
  const alertStyles = {
  ...
  return (
    <div
      className={`p-4 mb-4 rounded-lg flex flex-col ${alertStyles[type]}`}
      role="alert"
    >
